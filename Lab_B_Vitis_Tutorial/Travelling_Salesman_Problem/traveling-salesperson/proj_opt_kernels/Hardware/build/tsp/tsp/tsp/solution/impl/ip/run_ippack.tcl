...
set Version     "1.0"
set DisplayName "Tsp"
set Revision    "2111032136"
set Description "An IP generated by Vitis HLS"
set Device      "virtexuplushbm"
set AutoFamily  ""
set Taxonomy    "/VITIS_HLS_IP"
set target_part "xcu50-fsvh2104-2-e"
set target_lang "verilog"
set has_xpm_memory "0"
set has_blackbox "false"
set sdx_kernel_type "hls"
set xo_kernel_name "tsp"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/mnt/HLSNAS/r10943005/traveling-salesperson/proj_opt_kernels/Hardware/build/tsp/tsp/tsp/solution"
set debug_dir "/mnt/HLSNAS/r10943005/traveling-salesperson/proj_opt_kernels/Hardware/build/tsp/tsp/tsp/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {tsp_mux_42_32_1_1
tsp_mul_4ns_6ns_9_1_1
tsp_mul_22ns_24ns_45_2_1
tsp_urem_22ns_20ns_19_26_1
tsp_urem_19ns_17ns_16_23_1
...
tsp_mac_muladd_5s_5ns_6s_7_4_1
tsp_mul_mul_16ns_18ns_33_4_1
tsp_mac_muladd_6s_5ns_7s_7_4_1
tsp_mul_mul_13ns_15ns_27_4_1
tsp_mac_muladd_7s_5ns_7s_7_4_1
tsp_mul_mul_10ns_12ns_21_4_1
tsp_mac_muladd_7s_5ns_6ns_7_4_1
tsp_mac_muladd_6ns_5ns_7s_7_4_1
tsp_mac_muladd_7s_5ns_7ns_7_4_1
tsp_distances_0
tsp_control_s_axi
tsp_gmem_m_axi
tsp
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 distances_1 W 0x0 "Data signal of distances" {{0 32 distances W 0 "Bit 31 to 0 of distances"}}} {0x14 distances_2 W 0x0 "Data signal of distances" {{0 32 distances W 0 "Bit 63 to 32 of distances"}}} {0x1c shortestDistance_1 W 0x0 "Data signal of shortestDistance" {{0 32 shortestDistance W 0 "Bit 31 to 0 of shortestDistance"}}} {0x20 shortestDistance_2 W 0x0 "Data signal of shortestDistance" {{0 32 shortestDistance W 0 "Bit 63 to 32 of shortestDistance"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.333 machine 64 combinational 0 latency 907597 II x}
...
source -notrace "/opt/Xilinx/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"
