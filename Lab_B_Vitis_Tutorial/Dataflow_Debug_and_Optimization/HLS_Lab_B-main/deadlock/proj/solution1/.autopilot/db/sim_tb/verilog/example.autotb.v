...
`define AUTOTB_TVIN_A_V  "./c.example.autotvin_A_V.dat"
`define AUTOTB_TVIN_B_V  "./c.example.autotvin_B_V.dat"
`define AUTOTB_TVIN_A_V_out_wrapc  "./rtl.example.autotvin_A_V.dat"
`define AUTOTB_TVIN_B_V_out_wrapc  "./rtl.example.autotvin_B_V.dat"
`define AUTOTB_TVOUT_B_V  "./c.example.autotvout_B_V.dat"
`define AUTOTB_TVOUT_B_V_out_wrapc  "./impl_rtl.example.autotvout_B_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 4;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 29;
parameter LENGTH_A_V = 10;
parameter LENGTH_B_V = 10;
...
//------------------------FifoB_V Instantiation--------------

// The input and output of fifoB_V
wire  fifoB_V_wr;
wire  [31 : 0] fifoB_V_din;
wire  fifoB_V_full_n;
wire  fifoB_V_ready;
wire  fifoB_V_done;
...
assign      fifoB_V_wr        =   B_V_write & B_V_full_n;
assign      fifoB_V_din        =   B_V_din;
assign    fifoB_V_ready   =  0;   //ready_initial | AESL_done_delay;
assign    fifoB_V_done    =   AESL_done_delay;
// Assign input of dut
reg   reg_fifoB_V_full_n;
initial begin : gen_reg_fifoB_V_full_n_process
    integer proc_rand;
    reg_fifoB_V_full_n = fifoB_V_full_n;
    while (1) begin
        @ (fifoB_V_full_n);
        reg_fifoB_V_full_n = fifoB_V_full_n;
    end
...
assign      B_V_full_n    =   reg_fifoB_V_full_n;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.example.autotvout_B_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example.autotvout_B_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example.autotvout_B_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example.autotvout_B_V.dat\"!");
    else begin
        $display("Comparing rtl.example.autotvout_B_V.dat with impl_rtl.example.autotvout_B_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
initial begin : proc_gen_A_V_internal_ready
    ...
    initial begin : gen_ap_c_n_tvin_trans_num_A_V
        ...
        forever begin
            @ (posedge AESL_clock);
            if (end_A_V == 0) begin
                if (A_V_read == 1 && A_V_empty_n == 1) begin
                    if (size_A_V > 0) begin
                        size_A_V = size_A_V - 1;
                        while (size_A_V == 0 && end_A_V == 0) begin
                            ap_c_n_tvin_trans_num_A_V = ap_c_n_tvin_trans_num_A_V + 1;
