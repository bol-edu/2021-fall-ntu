...
set C_modelArgList {
	{ in_r int 8 regular {array 100 { 1 1 } 1 1 }  }
	{ out_r int 8 regular {array 100 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ out_r_d1 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	in_r { ap_memory {  { in_r_address0 mem_address 1 7 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 mem_dout 0 8 }  { in_r_address1 MemPortADDR2 1 7 }  { in_r_ce1 MemPortCE2 1 1 }  { in_r_q1 MemPortDOUT2 0 8 } } }
	out_r { ap_memory {  { out_r_address0 mem_address 1 7 }  { out_r_ce0 mem_ce 1 1 }  { out_r_we0 mem_we 1 1 }  { out_r_d0 mem_din 1 8 }  { out_r_address1 MemPortADDR2 1 7 }  { out_r_ce1 MemPortCE2 1 1 }  { out_r_we1 MemPortWE2 1 1 }  { out_r_d1 MemPortDIN2 1 8 } } }
}
