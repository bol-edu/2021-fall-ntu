...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "diamond.autotvin.dat"
	set constFileTvOut       "diamond.autotvout.dat"
	set constFileHdlTvIn     "diamond.autohdltvin.dat"
	set constFileHdlTvOut    "diamond.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
