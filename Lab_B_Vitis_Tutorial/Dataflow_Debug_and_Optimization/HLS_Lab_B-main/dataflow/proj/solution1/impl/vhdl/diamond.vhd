...
architecture behav of diamond is 
    ...
    "diamond_diamond,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flga2104-2-i,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=1.843000,HLS_SYN_LAT=152,HLS_SYN_TPT=50,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=194,HLS_SYN_LUT=626,HLS_VERSION=2020_2}";
    ...
    signal ap_channel_done_c3 : STD_LOGIC;
    signal funcB_U0_out_r_full_n : STD_LOGIC;
    ...
    signal ap_channel_done_c4 : STD_LOGIC;
    signal funcC_U0_out_r_full_n : STD_LOGIC;
    ...
    signal funcA_U0_start_full_n : STD_LOGIC;
    signal funcA_U0_start_write : STD_LOGIC;
    signal funcB_U0_start_full_n : STD_LOGIC;
    signal funcB_U0_start_write : STD_LOGIC;
    signal funcC_U0_start_full_n : STD_LOGIC;
    signal funcC_U0_start_write : STD_LOGIC;
    signal funcD_U0_start_full_n : STD_LOGIC;
    signal funcD_U0_start_write : STD_LOGIC;
...
begin
    ...
    ap_channel_done_c3 <= funcB_U0_ap_done;
    ap_channel_done_c4 <= funcC_U0_ap_done;
    ap_done <= funcD_U0_ap_done;
    ...
    ap_sync_done <= funcD_U0_ap_done;
    ap_sync_ready <= funcA_U0_ap_ready;
    ...
    funcA_U0_start_full_n <= ap_const_logic_1;
    funcA_U0_start_write <= ap_const_logic_0;
    funcB_U0_ap_continue <= c3_i_full_n;
    funcB_U0_ap_start <= c1_t_empty_n;
    funcB_U0_out_r_full_n <= c3_i_full_n;
    funcB_U0_start_full_n <= ap_const_logic_1;
    funcB_U0_start_write <= ap_const_logic_0;
    funcC_U0_ap_continue <= c4_i_full_n;
    funcC_U0_ap_start <= c2_t_empty_n;
    funcC_U0_out_r_full_n <= c4_i_full_n;
    funcC_U0_start_full_n <= ap_const_logic_1;
    funcC_U0_start_write <= ap_const_logic_0;
    funcD_U0_ap_continue <= ap_const_logic_1;
    funcD_U0_ap_start <= (c4_t_empty_n and c3_t_empty_n);
    funcD_U0_start_full_n <= ap_const_logic_1;
    funcD_U0_start_write <= ap_const_logic_0;
    vecIn_address0 <= funcA_U0_vecIn_address0;
    vecIn_address1 <= funcA_U0_vecIn_address1;
    vecIn_ce0 <= funcA_U0_vecIn_ce0;
    vecIn_ce1 <= funcA_U0_vecIn_ce1;
