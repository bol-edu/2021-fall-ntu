...
void hls_macc(signed int , signed int , signed int *, bool );
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @hls_macc(i32 %%10, i32 %%13, i32* %%accum_hw, i1 zeroext %%7) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_43_count);
  hls_macc(llvm_cbe_tmp__7, llvm_cbe_tmp__10, (signed int *)(&llvm_cbe_accum_hw), ((llvm_cbe_storemerge12&4294967295U) == (0u&4294967295U)));
if (AESL_DEBUG_TRACE) {
