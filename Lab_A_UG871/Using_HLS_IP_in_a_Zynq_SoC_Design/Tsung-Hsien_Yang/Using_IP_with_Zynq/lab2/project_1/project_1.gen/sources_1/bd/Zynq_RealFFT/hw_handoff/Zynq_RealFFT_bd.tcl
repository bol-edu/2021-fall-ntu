...
################################################################
# This is a generated script based on design: Zynq_RealFFT
#
...
# source Zynq_RealFFT_script.tcl
...
# Hierarchical cell: RealFFT
proc create_hier_cell_RealFFT { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_RealFFT() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 realfft_m_axis_dout

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 realfft_s_axis_din
  ...
  connect_bd_intf_net -intf_net hls_real2xfft_0_dout [get_bd_intf_pins hls_real2xfft_0/dout] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net hls_xfft2real_0_dout [get_bd_intf_pins realfft_m_axis_dout] [get_bd_intf_pins hls_xfft2real_0/dout]
  connect_bd_intf_net -intf_net realfft_s_axis_din_1 [get_bd_intf_pins realfft_s_axis_din] [get_bd_intf_pins hls_real2xfft_0/din_V_V]
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins hls_xfft2real_0/din] [get_bd_intf_pins xfft_0/M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins hls_real2xfft_0/ap_clk] [get_bd_pins hls_xfft2real_0/ap_clk] [get_bd_pins xfft_0/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins hls_real2xfft_0/ap_rst_n] [get_bd_pins hls_xfft2real_0/ap_rst_n] [get_bd_pins xfft_0/aresetn]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xfft_0/s_axis_config_tdata] [get_bd_pins xfft_0/s_axis_config_tvalid] [get_bd_pins xlconstant_1/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RealFFT
  create_hier_cell_RealFFT [current_bd_instance .] RealFFT
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net RealFFT_realfft_m_axis_dout [get_bd_intf_pins RealFFT/realfft_m_axis_dout] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_M_AXI_S2MM [get_bd_intf_pins axi_dma/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon/S01_AXI]
  ...
  connect_bd_intf_net -intf_net realfft_s_axis_din_1 [get_bd_intf_pins RealFFT/realfft_s_axis_din] [get_bd_intf_pins axi_dma/M_AXIS_MM2S]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RealFFT/aclk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins RealFFT/aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
