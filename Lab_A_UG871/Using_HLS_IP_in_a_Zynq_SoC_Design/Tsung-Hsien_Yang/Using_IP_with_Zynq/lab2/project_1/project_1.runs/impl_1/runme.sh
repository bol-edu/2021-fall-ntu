...
HD_PWD='E:/Courses/EEE5060/LabA/Using_IP_with_Zynq/lab2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_RealFFT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq_RealFFT_wrapper.tcl -notrace
