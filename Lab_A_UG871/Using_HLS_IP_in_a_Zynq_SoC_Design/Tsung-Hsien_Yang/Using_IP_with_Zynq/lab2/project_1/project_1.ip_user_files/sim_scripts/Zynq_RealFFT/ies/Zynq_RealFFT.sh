...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.Zynq_RealFFT \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/Zynq_RealFFT/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/Zynq_RealFFT/ipshared/34f8/hdl" \
       +incdir+"../../../../project_1.gen/sources_1/bd/Zynq_RealFFT/ipshared/ec67/hdl" \
       +incdir+"../../../../project_1.gen/sources_1/bd/Zynq_RealFFT/ipshared/34f8/hdl" \
