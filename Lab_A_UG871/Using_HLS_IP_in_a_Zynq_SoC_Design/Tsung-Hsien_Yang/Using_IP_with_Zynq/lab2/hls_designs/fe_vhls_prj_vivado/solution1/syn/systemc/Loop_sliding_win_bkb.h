...
#ifndef _Loop_sliding_win_bkb_H_
#define _Loop_sliding_win_bkb_H_
#include <systemc>
#include <iostream>
#include <fstream>
#include "AESL_pkg.h"
...
struct Loop_sliding_win_bkb_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(Loop_sliding_win_bkb_core);
    Loop_sliding_win_bkb_core(sc_core::sc_module_name) {
        SC_METHOD(proc_dout);
...
SC_MODULE( Loop_sliding_win_bkb )
{
    ...
    SC_CTOR( Loop_sliding_win_bkb ) {
        meminst = new Loop_sliding_win_bkb_core <DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    Loop_sliding_win_bkb_core <DataWidth, AddressWidth, AddressRange>* meminst;

};

#endif //_Loop_sliding_win_bkb_H_
