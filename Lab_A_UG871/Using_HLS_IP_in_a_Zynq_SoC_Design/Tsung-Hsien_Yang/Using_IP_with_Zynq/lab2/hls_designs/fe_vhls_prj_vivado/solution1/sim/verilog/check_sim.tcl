...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_real2xfft.autotvin_din_V_V.dat"
         "c.hls_real2xfft.autotvin_dout_V_data.dat"
         "c.hls_real2xfft.autotvin_dout_V_last_V.dat"
         "c.hls_real2xfft.autotvout_dout_V_data.dat"
         "c.hls_real2xfft.autotvout_dout_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_real2xfft.autotvout_dout_V_data.dat"
         "rtl.hls_real2xfft.autotvout_dout_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
