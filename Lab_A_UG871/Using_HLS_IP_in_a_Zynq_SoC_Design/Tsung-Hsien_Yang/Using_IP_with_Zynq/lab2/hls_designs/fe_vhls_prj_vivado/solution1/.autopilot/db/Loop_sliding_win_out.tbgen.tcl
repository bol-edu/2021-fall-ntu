set moduleName Loop_sliding_win_out
set isTopModule 0
...
set C_modelName {Loop_sliding_win_out}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "data2window_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "data2window_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "delayed_i_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "delayed_i_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "data2window_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "data2window_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "delayed_i_0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "delayed_i_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "nodelay_i_0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "nodelay_i_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "nodelay_i_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1024", "Max" : "1025"}
