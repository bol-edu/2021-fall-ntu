...
$(ObjDir)/xfft2real.cpp_pre.cpp.tb.o : xfft2real.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling xfft2real.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/hls_realfft_test.cpp_pre.cpp.tb.o : hls_realfft_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling hls_realfft_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/real2xfft.cpp_pre.cpp.tb.o : real2xfft.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling real2xfft.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
