...
// ==============================================================
#ifndef __hls_xfft2real_muldEe__HH__
#define __hls_xfft2real_muldEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_xfft2real_muldEe) {
    ...
    SC_CTOR(hls_xfft2real_muldEe):  ACMP_mul_us_U ("ACMP_mul_us_U") {
