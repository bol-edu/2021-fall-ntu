...
void hls_xfft2real_deshbi::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void hls_xfft2real_deshbi::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void hls_xfft2real_deshbi::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void hls_xfft2real_deshbi::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
