...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_xfft2real.autotvin_din_V_data.dat"
         "c.hls_xfft2real.autotvin_din_V_last_V.dat"
         "c.hls_xfft2real.autotvin_dout_V_data.dat"
         "c.hls_xfft2real.autotvin_dout_V_last_V.dat"
         "c.hls_xfft2real.autotvout_dout_V_data.dat"
         "c.hls_xfft2real.autotvout_dout_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_xfft2real.autotvout_dout_V_data.dat"
         "rtl.hls_xfft2real.autotvout_dout_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
