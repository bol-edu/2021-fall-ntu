...
if {[file isfile hls_xfft2real.autotvin.dat]} {
	file delete -force hls_xfft2real.autotvin.dat
}

if {[file isfile hls_xfft2real.autotvout.dat]} {
	file delete -force hls_xfft2real.autotvout.dat
}
