...
set ID 34
set hasByteEnable 0
set MemName hls_xfft2real_twid_rom_M_real_V_memcore
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 15
set AddrRange 256
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName hls_xfft2real_twid_rom_M_real_V
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
set ID 35
set hasByteEnable 0
set MemName hls_xfft2real_twid_rom_M_imag_V_memcore
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 16
set AddrRange 256
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName hls_xfft2real_twid_rom_M_imag_V
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# FIFO definition:
set ID 36
set FifoName hls_xfft2real_fifo_w32_d8_S
set InstName real_spectrum_lo_U
...
set ID 37
set FifoName hls_xfft2real_fifo_w32_d8_S
set InstName real_spectrum_hi_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 38
set FifoName hls_xfft2real_start_for_Loop_realfft_be_stream_output_proc6_U0
set InstName start_for_Loop_realfft_be_stream_output_proc6_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
