...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_xfft2real.autotvin.dat"
	set constFileTvOut       "hls_xfft2real.autotvout.dat"
	set constFileHdlTvIn     "hls_xfft2real.autohdltvin.dat"
	set constFileHdlTvOut    "hls_xfft2real.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
