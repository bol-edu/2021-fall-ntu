set moduleName Loop_realfft_be_buffer_proc3
set isTopModule 0
...
set C_modelName {Loop_realfft_be_buffer_proc3}
...
set C_modelArgMapList {[ 
	{ "Name" : "descramble_buf_0_M_imag_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "din_V", "interface" : "axis", "bitwidth" : 48, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ din_V_TDATA sc_in sc_lv 48 signal 2 } 
	{ din_V_TVALID sc_in sc_logic 1 invld 2 } 
	{ din_V_TREADY sc_out sc_logic 1 inacc 2 } 
	{ descramble_buf_0_M_real_V_address0 sc_out sc_lv 8 signal 3 } 
	{ descramble_buf_0_M_real_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ descramble_buf_0_M_real_V_we0 sc_out sc_logic 1 signal 3 } 
	{ descramble_buf_0_M_real_V_d0 sc_out sc_lv 16 signal 3 } 
	{ descramble_buf_1_M_real_V_address0 sc_out sc_lv 8 signal 4 } 
	{ descramble_buf_1_M_real_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ descramble_buf_1_M_real_V_we0 sc_out sc_logic 1 signal 4 } 
	{ descramble_buf_1_M_real_V_d0 sc_out sc_lv 16 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_din_V_U", "Parent" : "0"}]}
