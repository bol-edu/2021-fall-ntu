...
#define AUTOTB_TVOUT_din_V "../tv/cdatafile/c.hls_xfft2real.autotvout_din_V.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_din_V "../tv/rtldatafile/rtl.hls_xfft2real.autotvout_din_V.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_dout_V "../tv/rtldatafile/rtl.hls_xfft2real.autotvout_dout_V.dat"
...
extern "C" void hls_xfft2real_hw_stub_wrapper(volatile void *, volatile void *);
    ...
    string AESL_num;long __xlx_apatb_param_din_V_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_din_V_stream_buf_final_size; ++i)((hls::stream<__cosim_s6__>*)__xlx_apatb_param_din)->read();
...
std::vector<__cosim_s6__> __xlx_apatb_param_din_stream_buf;
{
  while (!((hls::stream<__cosim_s6__>*)__xlx_apatb_param_din)->empty())
    __xlx_apatb_param_din_stream_buf.push_back(((hls::stream<__cosim_s6__>*)__xlx_apatb_param_din)->read());
  for (int i = 0; i < __xlx_apatb_param_din_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s6__>*)__xlx_apatb_param_din)->write(__xlx_apatb_param_din_stream_buf[i]);
  }
long __xlx_apatb_param_din_stream_buf_size = ((hls::stream<__cosim_s6__>*)__xlx_apatb_param_din)->size();
...
hls_xfft2real_hw_stub_wrapper(__xlx_apatb_param_din, __xlx_apatb_param_dout);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_din_stream_buf_final_size = __xlx_apatb_param_din_stream_buf_size - ((hls::stream<__cosim_s6__>*)__xlx_apatb_param_din)->size();
...
__xlx_tmp_lv = ((long long*)&__xlx_apatb_param_din_stream_buf[j])[0];
