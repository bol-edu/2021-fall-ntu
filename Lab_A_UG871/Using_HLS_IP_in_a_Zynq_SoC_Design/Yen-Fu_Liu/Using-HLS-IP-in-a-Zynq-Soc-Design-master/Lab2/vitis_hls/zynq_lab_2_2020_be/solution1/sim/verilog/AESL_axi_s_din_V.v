...
`define TV_IN_din_V_TDATA "../tv/cdatafile/c.hls_xfft2real.autotvin_din_V.dat"
`define INGRESS_STATUS_din_V_TDATA "../tv/stream_size/stream_ingress_status_din_V.dat"
...
module AESL_axi_s_din_V (
    input clk,
    input reset,
    output [48 - 1:0] TRAN_din_V_TDATA,
    ...
    reg [48 - 1:0] din_V_TDATA_write_data;
    reg din_V_TDATA_read_en;
    wire [48 - 1:0] din_V_TDATA_read_data;
    
    fifo #(512, 48) fifo_din_V_TDATA (
        .reset(1'b0),
        .write_clock(clk),
