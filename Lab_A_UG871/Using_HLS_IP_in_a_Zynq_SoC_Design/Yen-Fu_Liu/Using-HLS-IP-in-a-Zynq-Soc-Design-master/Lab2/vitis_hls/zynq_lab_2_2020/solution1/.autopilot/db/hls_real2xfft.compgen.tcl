...
set ID 28
set hasByteEnable 0
set MemName hls_real2xfft_data2window_V_0_memcore
...
set MemName hls_real2xfft_data2window_V_0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dout_V_TDATA { O 48 vector } dout_V_TVALID { O 1 bit } dout_V_TREADY { I 1 bit } } \
} "
} else {
