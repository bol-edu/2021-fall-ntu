; ModuleID = 'C:/Users/ethan_kvm/AppData/Roaming/Xilinx/Vitis/zynq_lab_2_2020/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %struct.ap_fixed }
%struct.ap_fixed = type { %struct.ap_fixed_base }
%struct.ap_fixed_base = type { %struct.ssdm_int }
%struct.ssdm_int = type { i16 }
%"class.hls::stream.0" = type { %class.xfft_axis_t }
%class.xfft_axis_t = type { %"class.std::complex", %struct.ap_uint }
%"class.std::complex" = type { %struct.ap_fixed, %struct.ap_fixed }
%struct.ap_uint = type { %struct.ap_int_base }
%struct.ap_int_base = type { %struct.ssdm_int.1 }
%struct.ssdm_int.1 = type { i1 }

; Function Attrs: noinline
define void @apatb_hls_real2xfft_ir(%"class.hls::stream"* %din, %"class.hls::stream.0"* %dout) local_unnamed_addr #0 {
entry:
  %din_copy1 = alloca %"class.hls::stream", align 512
  %dout_copy = alloca %"class.hls::stream.0", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %din, %"class.hls::stream"* nonnull align 512 %din_copy1, %"class.hls::stream.0"* %dout, %"class.hls::stream.0"* nonnull align 512 %dout_copy)
  call void @apatb_hls_real2xfft_hw(%"class.hls::stream"* %din_copy1, %"class.hls::stream.0"* %dout_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %din, %"class.hls::stream"* nonnull align 512 %din_copy1, %"class.hls::stream.0"* %dout, %"class.hls::stream.0"* nonnull align 512 %dout_copy)
  ret void
}
...
; <label>:10:                                     ; preds = %8
  call fastcc void @streamcpy_hls.p0struct.ap_fixed(%struct.ap_fixed* align 512 %.01, %struct.ap_fixed* %.0)
  br label %ret
...
; <label>:13:                                     ; preds = %11
  call fastcc void @streamcpy_hls.p0struct.ap_fixed_base(%struct.ap_fixed_base* align 512 %.01.03, %struct.ap_fixed_base* %.0.02)
  br label %ret
...
; <label>:10:                                     ; preds = %8
  call fastcc void @streamcpy_hls.p0struct.ap_fixed(%struct.ap_fixed* align 512 %.01.0.05, %struct.ap_fixed* %.0.0.04)
  br label %19
...
; <label>:13:                                     ; preds = %11
  call fastcc void @streamcpy_hls.p0struct.ap_fixed_base(%struct.ap_fixed_base* align 512 %.01.0.0.07, %struct.ap_fixed_base* %.0.0.0.06)
  br label %19

; <label>:14:                                     ; preds = %11
  %.0.0.0.0.08 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
  %.01.0.0.0.09 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
  %15 = call i1 @fpga_fifo_exist_2(i8* %5)
  br i1 %15, label %16, label %17
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  %.0.0.112 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 1
  %.01.0.113 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 0, i32 1
  %20 = bitcast %struct.ap_fixed* %.0.0.112 to i8*
  %21 = call i1 @fpga_fifo_exist_2(i8* %20)
  br i1 %21, label %22, label %23

; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ap_fixed(%struct.ap_fixed* %.01.0.113, %struct.ap_fixed* %.0.0.112)
  br label %34

; <label>:23:                                     ; preds = %19
  %.0.0.1.014 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 1, i32 0
  %.01.0.1.015 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 0, i32 1, i32 0
  %24 = bitcast %struct.ap_fixed_base* %.0.0.1.014 to i8*
  %25 = call i1 @fpga_fifo_exist_2(i8* %24)
  br i1 %25, label %26, label %27

; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_fixed_base(%struct.ap_fixed_base* %.01.0.1.015, %struct.ap_fixed_base* %.0.0.1.014)
  br label %34

; <label>:27:                                     ; preds = %23
  %.0.0.1.0.016 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 1, i32 0, i32 0
  %.01.0.1.0.017 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 0, i32 1, i32 0, i32 0
...
; <label>:31:                                     ; preds = %27
  %.01.0.1.0.0.019.gep29 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %32 = bitcast i16* %.01.0.1.0.0.019.gep29 to i8*
  %.0.0.1.0.0.018.gep30 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %33 = bitcast i16* %.0.0.1.0.0.018.gep30 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %32, i8* align 1 %33, i64 2, i1 false)
  br label %34

; <label>:34:                                     ; preds = %31, %30, %26, %22
  %.0.120 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 1
  %.01.121 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 1
  %35 = bitcast %struct.ap_uint* %.0.120 to i8*
  %36 = call i1 @fpga_fifo_exist_1(i8* %35)
  br i1 %36, label %37, label %38

; <label>:37:                                     ; preds = %34
  call fastcc void @streamcpy_hls.p0struct.ap_uint(%struct.ap_uint* %.01.121, %struct.ap_uint* %.0.120)
  br label %ret

; <label>:38:                                     ; preds = %34
  %.0.1.022 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 1, i32 0
  %.01.1.023 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 1, i32 0
  %39 = bitcast %struct.ap_int_base* %.0.1.022 to i8*
  %40 = call i1 @fpga_fifo_exist_1(i8* %39)
  br i1 %40, label %41, label %42

; <label>:41:                                     ; preds = %38
  call fastcc void @streamcpy_hls.p0struct.ap_int_base(%struct.ap_int_base* %.01.1.023, %struct.ap_int_base* %.0.1.022)
  br label %ret

; <label>:42:                                     ; preds = %38
  %.0.1.0.024 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 1, i32 0, i32 0
  %.01.1.0.025 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 1, i32 0, i32 0
  %43 = bitcast %struct.ssdm_int.1* %.0.1.0.024 to i8*
  %44 = call i1 @fpga_fifo_exist_1(i8* %43)
  br i1 %44, label %45, label %46

; <label>:45:                                     ; preds = %42
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.1(%struct.ssdm_int.1* %.01.1.0.025, %struct.ssdm_int.1* %.0.1.0.024)
  br label %ret

; <label>:46:                                     ; preds = %42
  %.01.1.0.0.027.gep31 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %47 = bitcast i1* %.01.1.0.0.027.gep31 to i8*
  %.0.1.0.0.026.gep32 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %48 = bitcast i1* %.0.1.0.0.026.gep32 to i8*
...
declare void @apatb_hls_real2xfft_hw(%"class.hls::stream"*, %"class.hls::stream.0"*)

define void @hls_real2xfft_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.0"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  call void @hls_real2xfft_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.0"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  ret void
}

declare void @hls_real2xfft_hw_stub(%"class.hls::stream"*, %"class.hls::stream.0"*)
