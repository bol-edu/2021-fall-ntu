...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2020.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2020.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2020.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2020.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_real2xfft.autotvin.dat"
	set constFileTvOut       "hls_real2xfft.autotvout.dat"
	set constFileHdlTvIn     "hls_real2xfft.autohdltvin.dat"
	set constFileHdlTvOut    "hls_real2xfft.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
