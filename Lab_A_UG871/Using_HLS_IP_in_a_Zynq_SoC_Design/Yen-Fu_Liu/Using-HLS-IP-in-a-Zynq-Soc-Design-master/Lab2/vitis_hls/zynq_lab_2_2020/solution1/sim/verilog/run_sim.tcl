...
if {[file isfile hls_real2xfft.autotvin.dat]} {
	file delete -force hls_real2xfft.autotvin.dat
}

if {[file isfile hls_real2xfft.autotvout.dat]} {
	file delete -force hls_real2xfft.autotvout.dat
}
