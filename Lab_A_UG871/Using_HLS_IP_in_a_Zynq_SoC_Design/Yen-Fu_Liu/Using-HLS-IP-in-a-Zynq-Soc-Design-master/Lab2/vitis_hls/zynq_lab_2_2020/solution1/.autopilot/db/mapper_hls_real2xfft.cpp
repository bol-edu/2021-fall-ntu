...
extern "C" void hls_real2xfft(__cosim_s2__*, __cosim_s6__*);
extern "C" void apatb_hls_real2xfft_hw(volatile void * __xlx_apatb_param_din, volatile void * __xlx_apatb_param_dout) {
  ...
  vector<__cosim_s2__> __xlx_din_tmp_vec;
  while (!((hls::stream<__cosim_s2__>*)__xlx_apatb_param_din)->empty() && __xlx_din_V_tmp_Count < __xlx_din_V_read_Size) {
    __xlx_din_tmp_vec.push_back(((hls::stream<__cosim_s2__>*)__xlx_apatb_param_din)->read());
    __xlx_din_V_tmp_Count++;
  }
  ap_apatb_din_V_cap_bc = __xlx_din_tmp_vec.size();
  // store input buffer
  __cosim_s2__* __xlx_din_input_buffer= new __cosim_s2__[__xlx_din_tmp_vec.size()];
  ...
  // DUT call
  hls_real2xfft(__xlx_din_input_buffer, __xlx_dout_input_buffer);
