...
HD_PWD='C:/Users/ethan_kvm/hls_ip_zynq_lab2/hls_ip_zynq_lab2.runs/design_1_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xfft_0_0.tcl
