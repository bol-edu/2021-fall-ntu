...
proc create_hier_cell_RealFFT { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net hls_xfft2real_0_dout_V [get_bd_intf_pins realfft_m_axis_dout] [get_bd_intf_pins hls_xfft2real_0/dout_V]
  connect_bd_intf_net -intf_net realfft_s_axis_din_1 [get_bd_intf_pins realfft_s_axis_din] [get_bd_intf_pins hls_real2xfft_0/din_V]
  ...
  connect_bd_net -net Net [get_bd_pins xfft_0/s_axis_config_tdata] [get_bd_pins xfft_0/s_axis_config_tvalid] [get_bd_pins xlconstant_1/dout]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.TDATA_REMAP {16'b0000000000000000,tdata[47:0]} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net RealFFT_realfft_m_axis_dout [get_bd_intf_pins RealFFT/realfft_m_axis_dout] [get_bd_intf_pins axis_subset_converter/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_M_AXIS [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins axis_subset_converter/M_AXIS]
  ...
  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RealFFT/aclk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axis_subset_converter/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins RealFFT/aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axis_subset_converter/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
