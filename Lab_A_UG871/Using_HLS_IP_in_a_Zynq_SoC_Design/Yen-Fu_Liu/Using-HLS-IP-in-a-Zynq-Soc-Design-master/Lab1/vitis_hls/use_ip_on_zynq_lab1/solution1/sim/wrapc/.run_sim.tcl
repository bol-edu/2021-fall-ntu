...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_macc.autotvin.dat"
	set constFileTvOut       "hls_macc.autotvout.dat"
	set constFileHdlTvIn     "hls_macc.autohdltvin.dat"
	set constFileHdlTvOut    "hls_macc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
