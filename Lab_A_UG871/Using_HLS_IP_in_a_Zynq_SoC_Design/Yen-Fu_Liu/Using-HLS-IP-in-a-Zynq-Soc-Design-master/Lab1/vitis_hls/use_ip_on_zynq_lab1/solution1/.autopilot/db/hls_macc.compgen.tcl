...
set id 1
set name hls_macc_mul_32s_32s_32_2_1
...
set id 2
set name hls_macc_add_32ns_32ns_32_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 5 \
			corename hls_macc_HLS_MACC_PERIPH_BUS_axilite \
			name hls_macc_HLS_MACC_PERIPH_BUS_s_axi \
			ports {$port_HLS_MACC_PERIPH_BUS} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'HLS_MACC_PERIPH_BUS'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler hls_macc_HLS_MACC_PERIPH_BUS_s_axi
}
