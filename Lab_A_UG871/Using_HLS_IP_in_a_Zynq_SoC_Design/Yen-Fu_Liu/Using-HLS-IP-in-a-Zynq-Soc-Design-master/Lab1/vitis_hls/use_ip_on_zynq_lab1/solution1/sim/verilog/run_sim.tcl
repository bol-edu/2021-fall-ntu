...
if {[file isfile hls_macc.autotvin.dat]} {
	file delete -force hls_macc.autotvin.dat
}

if {[file isfile hls_macc.autotvout.dat]} {
	file delete -force hls_macc.autotvout.dat
}
