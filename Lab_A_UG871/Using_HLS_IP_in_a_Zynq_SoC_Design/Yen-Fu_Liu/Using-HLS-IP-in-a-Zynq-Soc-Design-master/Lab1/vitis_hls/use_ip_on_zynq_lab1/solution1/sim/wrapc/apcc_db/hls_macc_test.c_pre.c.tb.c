...
void apatb_hls_macc_sw(signed int , signed int , signed int *, bool );
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_hls_macc_sw(i32 %%10, i32 %%13, i32* %%accum_hw, i1 zeroext %%7) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_43_count);
  apatb_hls_macc_sw(llvm_cbe_tmp__7, llvm_cbe_tmp__10, (signed int *)(&llvm_cbe_accum_hw), ((llvm_cbe_storemerge12&4294967295U) == (0u&4294967295U)));
if (AESL_DEBUG_TRACE) {
