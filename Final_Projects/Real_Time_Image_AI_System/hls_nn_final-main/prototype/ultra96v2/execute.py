...
dma1 = resize_design.axi_dma_1 # output: class id 
dma2 = resize_design.axi_dma_2 # output: labelled image 
#dma3 = resize_design.axi_dma_3 # input: font input 
dma4 = resize_design.axi_dma_4 # font input 
#dma5 = resize_design.axi_dma_5 # word output
dma6 = resize_design.axi_dma_6 # input: image 
