...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "example.autotvin.dat"
	set constFileTvOut       "example.autotvout.dat"
	set constFileHdlTvIn     "example.autohdltvin.dat"
	set constFileHdlTvOut    "example.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
