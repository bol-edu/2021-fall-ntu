...
__attribute__((sdx_kernel("diamond", 0))) void diamond(data_t vecIn[100], data_t vecOut[100]);
...
__attribute__((sdx_kernel("diamond", 0))) void diamond(data_t vecIn[100], data_t vecOut[100])
{_ssdm_SpecArrayDimSize(vecIn, 100);_ssdm_SpecArrayDimSize(vecOut, 100);
#pragma HLS TOP name=diamond
# 20 "diamond.cpp"
