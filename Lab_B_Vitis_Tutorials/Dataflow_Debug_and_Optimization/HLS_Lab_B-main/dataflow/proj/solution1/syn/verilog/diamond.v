...
(* CORE_GENERATION_INFO="diamond_diamond,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flga2104-2-i,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=1.843000,HLS_SYN_LAT=152,HLS_SYN_TPT=50,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=194,HLS_SYN_LUT=626,HLS_VERSION=2020_2}" *)
...
wire    ap_channel_done_c3;
wire    funcB_U0_out_r_full_n;
...
wire    ap_channel_done_c4;
wire    funcC_U0_out_r_full_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
wire    funcA_U0_start_full_n;
wire    funcA_U0_start_write;
wire    funcB_U0_start_full_n;
wire    funcB_U0_start_write;
wire    funcC_U0_start_full_n;
wire    funcC_U0_start_write;
wire    funcD_U0_start_full_n;
wire    funcD_U0_start_write;
wire    ap_ce_reg;
...
assign ap_channel_done_c3 = funcB_U0_ap_done;

assign ap_channel_done_c4 = funcC_U0_ap_done;
...
assign ap_sync_done = funcD_U0_ap_done;

assign ap_sync_ready = funcA_U0_ap_ready;
...
assign funcA_U0_start_full_n = 1'b1;

assign funcA_U0_start_write = 1'b0;

assign funcB_U0_ap_continue = c3_i_full_n;

assign funcB_U0_ap_start = c1_t_empty_n;

assign funcB_U0_out_r_full_n = c3_i_full_n;

assign funcB_U0_start_full_n = 1'b1;

assign funcB_U0_start_write = 1'b0;

assign funcC_U0_ap_continue = c4_i_full_n;

assign funcC_U0_ap_start = c2_t_empty_n;

assign funcC_U0_out_r_full_n = c4_i_full_n;

assign funcC_U0_start_full_n = 1'b1;

assign funcC_U0_start_write = 1'b0;

assign funcD_U0_ap_continue = 1'b1;

assign funcD_U0_ap_start = (c4_t_empty_n & c3_t_empty_n);

assign funcD_U0_start_full_n = 1'b1;

assign funcD_U0_start_write = 1'b0;
